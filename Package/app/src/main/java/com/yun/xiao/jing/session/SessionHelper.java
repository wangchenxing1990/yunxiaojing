package com.yun.xiao.jing.session;
...
import com.yun.xiao.jing.DemoCache;
import com.yun.xiao.jing.R;
import com.yun.xiao.jing.redpacket.NIMRedPacketClient;
import com.yun.xiao.jing.session.action.AckMessageAction;
import com.yun.xiao.jing.session.action.FileAction;
import com.yun.xiao.jing.session.action.GuessAction;
import com.yun.xiao.jing.session.action.SnapChatAction;
import com.yun.xiao.jing.session.action.TipAction;
import com.yun.xiao.jing.session.activity.MessageHistoryActivity;
import com.yun.xiao.jing.session.activity.MessageInfoActivity;
import com.yun.xiao.jing.session.extension.CustomAttachParser;
import com.yun.xiao.jing.session.extension.CustomAttachment;
import com.yun.xiao.jing.session.extension.GuessAttachment;
import com.yun.xiao.jing.session.extension.RTSAttachment;
import com.yun.xiao.jing.session.extension.RedPacketAttachment;
import com.yun.xiao.jing.session.extension.RedPacketOpenedAttachment;
import com.yun.xiao.jing.session.extension.SnapChatAttachment;
import com.yun.xiao.jing.session.extension.StickerAttachment;
import com.yun.xiao.jing.session.search.SearchMessageActivity;
import com.yun.xiao.jing.session.viewholder.MsgViewHolderDefCustom;
import com.yun.xiao.jing.session.viewholder.MsgViewHolderFile;
import com.yun.xiao.jing.session.viewholder.MsgViewHolderGuess;
import com.yun.xiao.jing.session.viewholder.MsgViewHolderOpenRedPacket;
import com.yun.xiao.jing.session.viewholder.MsgViewHolderSnapChat;
import com.yun.xiao.jing.session.viewholder.MsgViewHolderSticker;
import com.yun.xiao.jing.session.viewholder.MsgViewHolderTip;
